...
TEST(ListTest, FrontTestGood1) {
  s21::list<int> test_list;
  test_list.push_front(3);
  test_list.push_front(7);
  test_list.push_front(7);
  test_list.push_front(10);
  EXPECT_EQ(test_list.front(), int{10});
}

TEST(ListTest, FrontTestGood2) {
  s21::list<double> test_list;
  test_list.push_back(3.4);
  test_list.push_back(7);
  test_list.push_back(7.2345);
  test_list.push_back(10);
  EXPECT_EQ(test_list.front(), double{3.4});
}

TEST(ListTest, FrontTestGood3) {
  s21::list<int> test_list;
  test_list.push_front(52);
  EXPECT_EQ(test_list.front(), 52);
}

TEST(ListTest, FrontTestGood4) {
  s21::list<std::string> test_list;
  test_list.push_front("world");
  test_list.push_front("hello");
  EXPECT_EQ(test_list.front(), "hello");
}

TEST(ListTest, FrontTestGood5) {
  s21::list<int> test_list;
  test_list.push_front(3);
  test_list.push_front(7);
  test_list.pop_back();
...
TEST(iterator_end_suite, pop_test) {
  ...
  auto s21_itr = s21_a.end();
  auto std_itr = std_a.end();
...
TEST(ListInsertManyTest, InsertMany) {
  s21::list<int> test_list = {1, 2};
  s21::list<int>::iterator test_itr = test_list.begin();
  ++test_itr;
  test_list.insert_many(test_itr, 5, 6);
  test_itr = test_list.begin();
  EXPECT_TRUE(*test_itr == 1);
  ++test_itr;
  EXPECT_TRUE(*test_itr == 5);
  ++test_itr;
  EXPECT_TRUE(*test_itr == 6);
  ++test_itr;
  EXPECT_TRUE(*test_itr == 2);
}
...
TEST(ListInsertManyTest, InsertManyFront) {
  ...
  s21::list<int>::iterator test_itr = test_list.begin();
  ++test_itr;
  test_list.insert_many_front(5, 6);
  test_itr = test_list.begin();
  EXPECT_TRUE(*test_itr == 6);
  ++test_itr;
  EXPECT_TRUE(*test_itr == 5);
...
TEST(ListInsertManyTest, InsertManyBack) {
  ...
  EXPECT_TRUE(*test_itr == 2);
  ++test_itr;
  EXPECT_TRUE(*test_itr == 3);
  ++test_itr;
  EXPECT_TRUE(*test_itr == 4);
  ++test_itr;
  EXPECT_TRUE(*test_itr == 5);
}
