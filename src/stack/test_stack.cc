...
TEST(stack_insert_many_front, insert) {
  s21::stack<int> s21_a({1, 2, 3});
  s21_a.insert_many_front(4, 5, 6);

  EXPECT_TRUE(s21_a.top() == 3);
  s21_a.pop();
  EXPECT_TRUE(s21_a.top() == 2);
  s21_a.pop();
  EXPECT_TRUE(s21_a.top() == 1);
  s21_a.pop();
  EXPECT_TRUE(s21_a.top() == 4);
  s21_a.pop();
  EXPECT_TRUE(s21_a.top() == 5);
  s21_a.pop();
  EXPECT_TRUE(s21_a.top() == 6);
}
